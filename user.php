...
<div class="container mt-5">
  <div class="card">
    ...
    <div class="card-body">
      <a href="add_user.php" class="btn btn-outline-success mb-3">
      ...
      <table class="table table-striped">
        ...
        while ($row = mysqli_fetch_assoc($result)) { ?>
          <tr>
            ...
            <td>
              <a href="edit_user.php?username=<?php echo $row['username'] ?>" class="btn btn-success">
                <i class="bi bi-pencil-square"></i>
              </a>
              <a href="del_user.php?username=<?php echo $row['username'] ?>" onclick="return confirm('ยืนยันการลบ?')" class="btn btn-danger">
